...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Member Benefits</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <!-- Add Button -->
    <a href="addmember.php" class="btn btn-success mb-3">Add</a>
    ...
    <table class="table table-bordered">
        ...
        $result = $conn->query("SELECT id, name, description, image, category FROM memberbfs");
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<td>";
          echo "<a href='editmember.php?id={$row['id']}' class='btn btn-warning edit-btn'>Edit</a>";
        ...
        ?>
              ...
              function deleteItem($itemId) {
                ...
                $result = $conn->query("SELECT category, image FROM memberbfs WHERE id = $itemId");
            
                if ($result && $row = $result->fetch_assoc()) {
                    // Delete query
                    $query = "DELETE FROM memberbfs WHERE id = $itemId";
...
<script>
    function confirmDelete(itemId) {
        if (confirm("Are you sure you want to delete this item?")) {
            ...
            window.location.href = "memberbfs.php?delete=" + itemId;
