...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Allied Businesses</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item active">Allied Businesses</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <!-- Add Button -->
    <a href="addallied.php" class="btn btn-success mb-3">Add</a>
    ...
    <table class="table table-bordered">
        ...
        $result = $conn->query("SELECT id, name, description, image, category FROM alliedbus");
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo "<td>";
          echo "<a href='editallied.php?id={$row['id']}' class='btn btn-warning edit-btn'>Edit</a>";
        ...
        ?>
              ...
              function deleteItem($itemId) {
                ...
                $result = $conn->query("SELECT category, image FROM alliedbus WHERE id = $itemId");
            
                if ($result && $row = $result->fetch_assoc()) {
                    // Delete query
                    $query = "DELETE FROM alliedbus WHERE id = $itemId";
...
<script>
    function confirmDelete(itemId) {
        if (confirm("Are you sure you want to delete this item?")) {
            ...
            window.location.href = "alliedbus.php?delete=" + itemId;
