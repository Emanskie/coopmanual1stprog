...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Edit Allied Businesses</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item active">Edit Allied Businesses</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <a href="alliedbus.php" class="btn btn-secondary">Back</a>
                ...
                function getItemDetails($itemId)
                {
                    ...
                    $result = $conn->query("SELECT id, name, description, image FROM alliedbus WHERE id = $itemId");
                ...
                if (isset($_POST['edit_submit'])) {
                    ...
                    // Update query
                    $query = "UPDATE alliedbus SET name = '$editName', description = '$editDescription', image = '$editImage' WHERE id = $editId";
