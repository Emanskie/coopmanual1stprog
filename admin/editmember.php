...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Edit Member Benefits</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item active">Edit Member Benefits</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <a href="memberbfs.php" class="btn btn-secondary">Back</a>
                ...
                function getItemDetails($itemId)
                {
                    ...
                    $result = $conn->query("SELECT id, name, description, image FROM memberbfs WHERE id = $itemId");
                ...
                if (isset($_POST['edit_submit'])) {
                    ...
                    // Update query
                    $query = "UPDATE memberbfs SET name = '$editName', description = '$editDescription', image = '$editImage' WHERE id = $editId";
