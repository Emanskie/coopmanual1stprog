...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add Member Benefits</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item active">Add Member Benefits</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="form-group">
        <select class="form-control" name="category" required>
          <option value="" disabled selected>Select a Category</option>
            <option value="coopcare">Enhanced Coop Care</option>
            <option value="sunshine">Sunshine Fund</option>
            <option value="yakap">Yakap-Yaman sa Kalusugan Program</option>
        </select>
    </div>
...
<a href="memberbfs.php" class="btn btn-secondary">Back</a>
...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $query = mysqli_query($conn, "INSERT INTO memberbfs (name, description, image, category) VALUES ('$name', '$description', '$imgnewfile', '$category')");

        if ($query) {
            echo "<script>alert('You have successfully inserted the data');</script>";
            echo "<script type='text/javascript'> document.location ='memberbfs.php'; </script>";
        } else {
