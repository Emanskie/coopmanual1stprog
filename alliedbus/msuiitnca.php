...
<style>
        ...
        <div class="container-card">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                $selectedCategory = "msuiitnca"; // Default category, change this based on your needs

                if (isset($_GET['category'])) {
                    $selectedCategory = $_GET['category'];
                }

                $result = $conn->query("SELECT id, name, image FROM alliedbus WHERE category = '$selectedCategory'");

                echo "<div class='container mt-4'>";
                echo "<h2>MSU-IIT National Cooperative Academy</h2>";
