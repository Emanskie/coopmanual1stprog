            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="icon-box" data-aos="fade-up">
                        ...
                        <h4 class="title"><a href="\CoopManual\alliedbus\msuiitnca.php">MSU-IIT National Cooperative Academy</a>
                        </h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h4 class="title"><a href="\CoopManual\alliedbus\climbs.php">Insurance offered from CLIMBS</a></h4>
                        <p class="description"></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h4 class="title"><a href="\CoopManual\alliedbus\housingcoop.php">Housing Cooperative</a></h4>
                        <p class="description"></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <h4 class="title"><a href="\CoopManual\alliedbus\agribus.php">Agri-Business</a></h4>
                        <p class="description"></p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
