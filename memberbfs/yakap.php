...
<style>
        ...
        <div class="container-card">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                $selectedCategory = "yakap"; // Default category, change this based on your needs

                if (isset($_GET['category'])) {
                    $selectedCategory = $_GET['category'];
                }

                $result = $conn->query("SELECT id, name, image FROM memberbfs WHERE category = '$selectedCategory'");

                echo "<div class='container mt-4'>";
                echo "<h2>Yakap-Yaman sa Kalusugan Program</h2>";
