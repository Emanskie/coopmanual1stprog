...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add Loan Products</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="admin.php">Home</a></li>
          <li class="breadcrumb-item active">Add Loans</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <select class="form-control" name="category" required>
                ...
                <option value="msmeloan">MSME Loan</option>
                <option value="creditline">Credit Line</option>
                <option value="backtobackloan">Back-to-Back Loan</option>
                <option value="pettyloan">Enhanced Petty Cash Loan</option>
                <option value="personalloan">Personal Loan</option>
                <option value="salary">Salary Loan</option>
                <option value="educloan">Education Loan</option>
                <option value="pensionerloan">Pensioner Loan</option>
                <option value="medloan">Medical Emergency Loan</option>
                <option value="carloan">Enhanced Car Financing Loan</option>
                <option value="gadgetloan">Gadget and Appliances Loan</option>
                <option value="bonusloan">Bonus/Incentive Loan</option>
                <option value="lguloan">LGU Salary Loan</option>
            </select>
        </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $query = mysqli_query($conn, "INSERT INTO loans (name, description, image, category) VALUES ('$name', '$description', '$imgnewfile', '$category')");
